...
; а также выводящий точку при нажатии каждой второй латинской буквы, если
; первая была "u"
...
DOT ENDP
 ...
 MOV BH,' '             ;в BH пробел
symbol PROC NEAR	; ВЫВОД ПРОБЕЛА ПРИ 'ъ'
  MOV AH,03H		; СДВИГ КУРСОРА НА
  INT 10H		; СИМВОЛ ПЕРЕД ПРЕДЫДУЩИМ
  DEC DL			; И ЗАПИСЬ ЕГО В AL


  CMP AL,'ъ'         ;если в al, Ъ
  JNE M1
 
  AL,BH           ;если  AL = ъ, то в AL пробел
...
ret
initial endp
msg1 db '<<< Console driver [by Mossolov Fedor, IT-4] >>>',0dh,0ah,'$'
